  ...
  return (
    <div className="bg-[#FAF3DD]/90 backdrop-blur-xl border border-[#562C2C]/10 rounded-3xl p-5 h-full flex flex-col relative overflow-hidden">
      ...
      <div className="flex items-center gap-2 mb-4 relative z-10">
        ...
        <div>
            <h3 className="text-[#562C2C] font-bold leading-none">Brain Clarity</h3>
            <p className="text-[10px] text-[#562C2C]/60 font-medium">Real-time Cognitive Index</p>
        </div>
      </div>
         ...
         {metrics.map((m) => (
            <div key={m.label} className="w-full">
               <div className="flex justify-between items-center text-xs mb-1.5">
                  <div className="flex items-center gap-1.5 text-[#562C2C]/80 font-bold">
                    <m.icon size={14} className="text-[#562C2C]/40" />
                    {m.label}
                  </div>
                  <span className="font-bold text-[#562C2C]">{m.value.toFixed(0)}%</span>
               </div>
               <div className="h-2.5 w-full bg-[#562C2C]/5 rounded-full overflow-hidden border border-[#562C2C]/5">
                  <div 
      ...
      <div className="mt-auto pt-4 relative z-10">
        <div className="bg-white/50 rounded-xl p-2.5 flex items-start gap-2.5 border border-[#562C2C]/5">
            <Info size={16} className="text-[#E07A5F] mt-0.5 flex-shrink-0" />
